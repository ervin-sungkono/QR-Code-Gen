  ...
  return (
    <Layout>
      <div className="flex justify-center items-center w-full h-full px-4 py-8">
        <div className="w-full h-full max-w-[320px] flex flex-col bg-gray-200 shadow-md border border-black/20 rounded-lg py-4 px-4">
          {preview ? 
          <div ref={previewRef} className="relative w-full flex-shrink-0 aspect-square mb-4">
            ...
            {logo && <Image src={logo} alt="qr-code-preview" fill className="scale-[0.25] object-cover"/>}
          </div>:
